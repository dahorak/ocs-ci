...
def prepare_disconnected_ocs_deployment():
    ...
    if config.DEPLOYMENT.get("live_deployment"):
        ...
        # redhat_operators_cs = CatalogSource(
        #     resource_name="redhat-operators",
        #     namespace=constants.MARKETPLACE_NAMESPACE,
        # )
        # redhat_operators_cs_image = (
        #     f"{redhat_operators_cs.get_image_url()}:v{redhat_operators_cs.get_image_tag()}"
        # )
        ...
        exec_cmd(cmd, timeout=3600)

        # ImageContentSourcePolicy file path
